  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in duration-500">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-white tracking-tight">Add New Website</h1>
          <p className="text-zinc-400 mt-1">Register a new website and associate it with a client.</p>
        </div>
      </div>

      <div className="glass rounded-2xl p-6 md:p-8 border border-zinc-800/50">
        <WebsiteForm clients={clients} action={createWebsite} />
      </div>
    </div>
  );
}
